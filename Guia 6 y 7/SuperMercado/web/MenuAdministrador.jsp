...
<html>
    <head>
     ...
     <body>
        <div>Bienvenido al Sistema de Super Mercado</div>
        <nav>
            <ul>
                <li><a href="/SuperMercado">Inicio del sistema de Super Mercado</a></li>
                <li><a href="/SuperMercado?accion=Login">Login</a></li>
                <li><a href="/SuperMercado?accion=GestionarEmpleados">GestionarEmpleados</a></li>
